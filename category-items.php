    ...
    <section class="food-search text-center">
        <div class="container">
            ...
            <h2 ><div >Items on</div> <a href="#" class="text-white">"<?php echo $category_title; ?>"</a></h2>
                            ...
                            <div class="food-menu-img">
                                <?php 
                                    ...
                                    else
                                    {
                                        //Image Available
                                        ?>
                                        <img src="<?php echo SITEURL; ?>images/items/<?php echo $image_name; ?>" alt="Image" class="img-responsive img-curve">
                                        <?php
                                    }
                                ?>
