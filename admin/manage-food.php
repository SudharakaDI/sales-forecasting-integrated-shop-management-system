...
<div class="main-content">
    <div class="wrapper">
        <h1 class="italic">Manage Items</h1>
                            ...
                            while($row=mysqli_fetch_assoc($res))
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="http://127.0.0.1:3000/result?id=<?php echo $id; ?>&category_id=<?php echo $category_id; ?>&price=<?php echo $price; ?>" class="btn-danger">Predict Sales</a>
                                    </td>
                                </tr>
