        ...
        <div >
            ...
            <form action="" method="POST" class="order text-white">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g. Sudharaka Fernando" class="input-responsive" required>

                    <div class="order-label">Phone Number</div>
                    <input type="tel" name="contact" placeholder="E.g. 0775xxxxxx" class="input-responsive" required>

                    <div class="order-label">Email</div>
                    <input type="email" name="email" placeholder="E.g. sudharaka@gmail.com" class="input-responsive" required>
